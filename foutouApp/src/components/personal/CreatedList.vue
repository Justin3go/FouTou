...
onMounted(async () => {
  ...
  console.log("buy: ",res);
  let res1 = await auth.E_register('0xF9F4eD85E440BfD7A8bADE33454C32dB9E66b283')
  let res2 = await auth.E_register('0xF9F4eD85E440BfD7A8bADE33454C32dB9E66b283')
  console.log("register: ", res1);
  let r = res1[0];
  let d = r.data;
  let t = r.topics;
